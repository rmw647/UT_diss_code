...
#define IT		4100	/*number of iterations for FP algorithm*/
#define VGAP	0.001		/*convergence criterion*/
#define ALPHA		0.185		/*exponent in denominator of payoff calculation--
							payoff = DP/(FOM*mass)^alpha*/
#define SIMYEAR	360	/*360 days in a simulation year*/

char fileName[] = "results_4100_001_0185.txt";
