...
/*for payoff2, set PAYOFF equal to 1; for payoff1, PAYOFF = 0*/
...
/*user input values*/
#define PAYOFF	1		/*1 - payoff2, 0- payoff1*/
...
char fileName[] = "results_r_2000_01_new.txt";
...
#define LRFDCOST	150.0		/*3DLRFD cost-- do not include in "fixed costs" in info array
...
/*calculate payoff for given defender-attacker strategy pair*/
int dstrat = 1;
int astrat = 33;
