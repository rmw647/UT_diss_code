...
#define BUDGET		2225		/*defender budget*/
...
#define IT		2	/*number of iterations for FP algorithm*/
...
char fileName[] = "results_r_2225_0_old.txt";
...
printf("DP:%.4f\n",calcPayoff(defstrats[1],attstrats[6]));
