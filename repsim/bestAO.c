/*scans through all reprocessing attacker option and produces FOM * quantTRU for each option*/
/*use to find best AO for normalized payoff*/
...
/* scan through all attacker options and print to file*/
for (i=0;i<MAXASTRATS;i++)
	fprintf(fp,"%d\t%.6f\n",i,calcPayoff(defstrats[1],attstrats[i]));
