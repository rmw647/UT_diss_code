...
#define BUDGET	800		/*defender budget*/
...
char fileName[] = "enr_800_015";

float epsilon = 0.1;				/*in payoff-- 1-epsilon*DP in denominator-- epsilon
...
/*	xplay[it_num-1] = currentrow;
	...
	printf("cost: %ld\n\n",calcCost(defstrats[204120],attstrats[151]));
}
